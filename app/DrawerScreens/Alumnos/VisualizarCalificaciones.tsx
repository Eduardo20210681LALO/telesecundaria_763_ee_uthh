...
export default function VisualizarCalificaciones() {
  ...
  const fetchCalificaciones = (
    ...
    axios
      .get(
        `https://telesecundaria763.host8b.me/Web_Services/TeleSecundaria763Movil/Docentes/ObtenerCalificaciones.php?matricula=${matricula}&periodo=${periodo}&grado=${grado}&grupo=${grupo}`
      )
      .then((response) =>
        setCalificaciones(
          Array.isArray(response.data.calificaciones)
            ...
            {selectedStudent && (
              <>
                <Text style={styles.modalTitle}>
                  Calificaciones de {selectedStudent.vchNombre}{" "}
                  {selectedStudent.vchAPaterno} {selectedStudent.vchAMaterno}
                </Text>
